...
| B5d / #106 | PR open on `codex/issue-95-b5-scout-config-storage` | [PR #107](https://github.com/diese-tech/Ratatoskr/pull/107) | Async Scout configuration store and SQLite adapter; `/scout config`, role select and emoji binding conversion; 278 tests locally | Final-head review/CI; Scout lifecycle and Postgres implementation remain separate |
