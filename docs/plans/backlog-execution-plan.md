...
| B5f / #110 | In progress on `codex/issue-95-b5-scout-signup-storage` | PR pending | Async signup/working-roster store and SQLite adapter started; caller conversion pending | Complete reaction/restart/member-refresh conversion and local gates; published lifecycle and Postgres remain separate |
