...
| B5d / #106 | In progress on `codex/issue-95-b5-scout-config-storage` | [Issue #106](https://github.com/diese-tech/Ratatoskr/issues/106) | Async Scout configuration store and SQLite adapter; `/scout config`, role select and emoji binding conversion; 278 tests locally | Review/CI; Scout lifecycle and Postgres implementation remain separate |
