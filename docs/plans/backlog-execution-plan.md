...
| B5c / #104 | In progress on `codex/issue-95-b5-division-storage` | [Issue #104](https://github.com/diese-tech/Ratatoskr/issues/104) | Async division workspace and SQLite adapter; division command/provisioning conversion; shared legacy Scout lock scope; 275 tests locally | Review/CI; no division behavior change, Scout conversion, or Postgres implementation |
