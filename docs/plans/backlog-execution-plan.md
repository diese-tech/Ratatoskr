...
| 2.9 | Record B5g as merged and #90 as fully specified and locally complete with a fixed three-hour deadline, durable automatic closure/Discord reconciliation, recovery exceptions, fair retry paging, final-readiness/notification-lock/backlog safety, and audit evidence | PRs #113/#115, Issue #90, tracker #95, 313 tests and local gate evidence |
