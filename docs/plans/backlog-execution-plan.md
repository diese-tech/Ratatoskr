...
| Three-hour Scout cleanup / #90 | Code complete in PR #115; review repairs applied; local gates green | [Issue #90](https://github.com/diese-tech/Ratatoskr/issues/90), [PR #115](https://github.com/diese-tech/Ratatoskr/pull/115) | Fixed start+3h deadline; automatic cancel/finish; publication recovery exception; durable Discord repair/audit; final-readiness and notification-lock safety; restart/race coverage; 309 tests | Rerun exact-head review and CI; live Discord behavior remains unverified |
...
| 2.9 | Record B5g as merged and #90 as fully specified and locally complete with a fixed three-hour deadline, durable automatic closure/Discord reconciliation, recovery exceptions, final-readiness/notification-lock safety, and audit evidence | PRs #113/#115, Issue #90, tracker #95, 309 tests and local gate evidence |
