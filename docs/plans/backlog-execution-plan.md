...
| Three-hour Scout cleanup / #90 | Code complete in PR #115; review repairs applied; local gates green | [Issue #90](https://github.com/diese-tech/Ratatoskr/issues/90), [PR #115](https://github.com/diese-tech/Ratatoskr/pull/115) | Fixed start+3h deadline; automatic cancel/finish; publication recovery exception; durable Discord repair/audit; final-readiness, notification-lock, overdue-backlog, fair recovery/retry paging, startup ordering, and uncertain-notice preservation; restart/race coverage; 316 tests | Rerun exact-head review and CI; live Discord behavior remains unverified |
