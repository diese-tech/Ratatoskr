...
- Once a published scout is over, use **Finish scout** on its Scout Ops card and confirm privately. The bot records the staff member and completion time, marks both posts finished, and removes editing controls. Signups, roster assignments and historical readiness remain stored. Finishing is final; previously opened player-edit forms also become inert. Publication or roster delivery must be settled first. There is no automatic expiration by scheduled time.
